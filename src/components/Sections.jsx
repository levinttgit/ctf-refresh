...
const Sections = () => {
    return (
        <div className="content-sections">
            {/* Three Invitations Section (Inspired by Passion Creek) */}
            <section className="invitations-section container" id="about">
                ...
                <div className="cards-grid">
                    ...
                    <div className="card feature-card">
                        ...
                        <a href="#visit" className="card-link">Get Directions &rarr;</a>
                    </div>
                    ...
                    <div className="card feature-card">
                        ...
                        <a href="#groups" className="card-link">Find a Group &rarr;</a>
                    </div>
                    ...
                    <div className="card feature-card">
                        ...
                        <a href="#give" className="card-link">Give Now &rarr;</a>
                    </div>
            ...
            <section className="service-times-section" id="services">
                <div className="container service-times-content">
                    ...
                    <div className="service-image-placeholder">
                        {/* Typically a beautiful wide shot of worship. We will use a polished placeholder layout */}
